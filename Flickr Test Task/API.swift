...
class API {
    ...
    func getRecentPhoto(page: Int, method: Method, per_page: Int, completion: @escaping(_ jsonArr: [JSON]) -> Void) {
        let parameters: Parameters = ["method": method.rawValue,
                                      "api_key": api_key,
                                      "extras": "url_n",
                                      "page": page,
                                      "per_page": per_page,
                                      "format": "json",
                                      "nojsoncallback": 1]
        Alamofire.request(Urls.baseUrl, method: .get, parameters: parameters, encoding: URLEncoding.default, headers: nil).responseJSON { (responseJSON) in
